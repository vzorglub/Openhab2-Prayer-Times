...
------------------------ User Interface -------------------------
	...
	getSettings ()            // get current calculation parameters
...
if __name__ == "__main__":
    ...
    timeZoneOffset = (datetime.now() - datetime.utcnow()).seconds;
    if (timeZoneOffset > 1000):
        timeZoneOffset = 1
    else:
        timeZoneOffset = 0
    prayTimes = PrayTimes('ISNA');

    #Here the parameters for calculations are passed to the PrayTimes object
    #The parameters are are follow:

    #fajr - Angle of the sun for fajr in degrees - default: 18
    #isha - Angle of the sun for Isha in degress - default: 17
    #imsak - twilight angle in degress - eg: 18
    #imsak - minutes before fajr - eg: 10 min - default: 10 min
    #dhuhr - minutes after mid-day - eg: 1 min - default: 0 min
    #asr - Standard - Shafii, Maliki, Jafari and Hanbali (shadow factor = 1) - eg: Standard - default: Standard
    #asr - Hanafi - Hanafi school of tought (shadow factor = 2) - eg: Hanafi
    #asr - shadow length factor for realizing asr- eg: 1.7
    #maghrib - twilight angle in degrees - eg: 4
    #maghrib - minutes after sunset - eg: 15 min - default: 0 min
    #isha - twilight angle in degrees - eg: 18
    #isha - minutes after maghrib - eg: 90 min
    #midnight - Standard - The mean time from Sunset to Sunrise - eg: Standard - default: Standard
    #midnight - Jafari - The mean time from Maghrib to Fajr - eg: Jafari

    # higher latitudes adjustment
    #highLats - No adjustments - None - eg: None     
    #highLats - The middle of the night method - eg: NightMiddle - default: NightMiddle
    #highLats - The 1/7th of the night method - eg: OneSeventh
    #highLats - The angle-based method (recommended) - eg: AngleBased

    #example: prayTimes.adjust( {fajr: 16, dhuhr: '5 min', asr: 'Hanafi', isha: 15} );

    prayTimes.adjust( {'highLats':'AngleBased', 'fajr': 15, 'isha': 15 } );

    #Enter here your latitude and longitude (and your altitude (optional))
    times = prayTimes.getTimes(date.today(), (YOUR LAT,YOUR LON,0), timeZoneOffset);
    print times;
